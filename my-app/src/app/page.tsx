...
export default function Home() {
  ...
  return (
    <>
      {/* Background overlay with blur effect when modal is open */}
      {showModal && (
      ...
      {/* Modal - con z-index superior para aparecer por encima del overlay */}
      {showModal && selectedAlert && (
        <div className="fixed inset-0 z-30 flex items-center justify-center">
          <div className="bg-[#E4D5C1] rounded-md shadow-lg w-[95%] max-w-md">
